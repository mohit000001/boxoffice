...
<html lang="US-en">   
  <head>
     ...
     <link href="mainstylesheet.css" rel="stylesheet" media="all" type="text/css"/>  
         ...
         <link href="login_middle_bar.css" rel="stylesheet" media="all" type="text/css"/> 
...
<body onload="notification_text_animation()">
<div class="top">
     ...
     <a href="signin.html"><button class="signin_button" type="button">create new account</button></a>
...
<div class="middle">
  ...
  <div class="midd">
      ...
      <div class="tag_line_login">login to boxoffice <img id="box_img_with_tag_line"  src="boxoffice-footer.png" height="30px" width="100px" alt="box office logo"/></div>
       
	  <form accept-charset="UTF-8" novaildate action="check_login.php" method="post" name="login_form" id="login_from_id">
	  
         <div id="login_fail_warning">your entered info is not matching with our server</div>
		 
         <input placeholder=" User_name or Email or Mobile no" size="50" name="box_id" type="text"/><br><br><br>
		 
	     <input placeholder=" Password" type="Password" name="box_pass" size="50"/><br><br><br>
		 
         <button type="submit" class="login_submit_button">Login	</button>	


		<br><br><a href="forgotton_password.php" class="forgot_pass">forgotton password ?</a><div style="color:blue; font-size:11px; text-transform:capitalize;"> haven't boxoffice account <a href="sigin.php">click here</a> to create a new boxoffice account</div>		 
...
<div class="bottom">
     ...
     <div style="position:relative; bottom:360px; left:400px; font-family: Century Schoolbook;  word-spacing:5px;  color:azure;font-weight:500; ">@CopyRight BOX OFFICE  2000-2017 -----<span style="color:red">All Rights Reserved:</span></div>
   
 </div>
 <?php
    if(isset($_SESSION["login_field"]))
	{
	if($_SESSION["login_field"]=="yes")
	  {
	    echo "<script>login_fail();</script>";
	     session_destroy();
	  }
    }
	if(isset($_SESSION["change_pass_succ"]))
	{
     	if($_SESSION["change_pass_succ"]=="yes")
	 
	 
	   {
	         
			 echo "<script>change_pass_su();</script>";
	         session_destroy();
	  }
	} 
 ?>
