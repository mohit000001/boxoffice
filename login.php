...
<div class="middle">
  ...
  <div class="midd">
      ...
      <div id="change_pass_notice">you have successly changed your password login with your new password</div> 
	  <div id="login_warning_client_side"></div>
	  <form accept-charset="UTF-8" novaildate action="check_login.php" method="post" name="login_form" id="login_from_id" onsubmit="return validate_login()">
