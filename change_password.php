...
<html lang="US-en">   
  <head>
     ...
     <link href="mainstylesheet.css" rel="stylesheet" media="all" type="text/css"/>  
         ...
         <link href="change_password_middle_bar.css" rel="stylesheet" media="all" type="text/css"/> 
...
<body onload="notification_text_animation(),anymouse_user(),empty_officle_form_data()">
<div class="top">
...
<div class="middle">
  ...
  <div class="midd">
			 ...
			 <div id="page_warning">don't refresh the page and don't click on back button else you will be not able to change password </div>
			 <br>
             <div id="serverside_pass_warning">deu to some technical error the process was not succefulled try again or try after some time</div>
			 <div id="cilentside_pass_warning">shortout all warnings in red color and password should match with our polices</div>
            <form accept-charset="UTF-8" action="password_change.php" onsubmit="return full_val_che()" method="post" name="change_password_form" id="change_password_form" novalidate>
                 <center><legend>change your password : </legend></center>    	<br>
	         <span style="font-size:15px; font-weight:700;">New password : </span> <input name="new_pass" type="password" placeholder="Enter your new password" size="30" onblur="password_validation(this.value)" onkeyup="password_strenth(this.value)"/>
          <br>
          ...
          <span id="password_warning" style="position:relative; left:80px; top:10px; color:red; font-size:10px; "></span><br><br><br>
			 
			<span style="font-size:15px; font-weight:700;"> Re-enter : </span><input id="re_pass" style="position:relative; left:40px;" name="re_new_pass" type="password" placeholder="Re Enter your new password" size="30" onblur="re_password_validation(this.value)"><br>
          
          <span id="re-password_warning" style="position:relative; left:80px; top:10px; color:red; font-size:10px; "></span>
			 
			 <br><br><br><button type="submit" id="change_password_submit_button">done</button>
...
<div class="bottom">
 ...
 <?php
       if(isset($_SESSION["change_pass_serverside_error"]))
	   {
      if($_SESSION["change_pass_serverside_error"]=="yes")
	 {
	   echo "<script>server_side_ac_conform_error();</script>";
	  
	   unset($_SESSION["change_pass_serverside_error"]);
	 }
	}
