...
<html lang="US-en">   
  <head>
     ...
     <link href="mainstylesheet.css" rel="stylesheet" media="all" type="text/css"/>  
         ...
         <link href="tandc_middle_bar.css" rel="stylesheet" media="all" type="text/css"/> 
...
<div class="middle">
  ...
  <div class="midd">
      <div id="website_underconstraction_message">
	   : this website is now in development process<br>
	   therefor <span style="color:red; text-decoration:underline;">term and conditions</span> are not available at this time
	  </div>
    </div>
  <div class="right">
