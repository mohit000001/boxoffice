...
<div class="middle">
  ...
  <div class="midd">
      ...
      <form accept-charset="UTF-8" enctype="multipart/form-data" action="upload_profile_pic.php" method="post" name="profile_pic_form" class="profile_pic_form" onsubmit="return validation()" novalidate>
         
          <center><legend>upload a profile picture</legend></center>
          
          <img src="black_profile_pic.jpg" height="250px" width="350px" style="position:relative; left:60px;" alt="profile pic"/><br><br><br><br><br><br>
          ...
          <a href="signin_next_next.php"><button type="button" class="skip_button">Skip</button></a>
