...
<html lang="US-en">   
  <head>
     ...
     <link href="mainstylesheet.css" rel="stylesheet" media="all" type="text/css"/>  
         ...
         <link href="account_conformation_middle_bar.css" rel="stylesheet" media="all" type="text/css"/> 
	  ...
	  <script src="account_conformation.js"></script>
...
?>
  ...
  <div class="midd">
       ...
       <div class="conform_account_box">
           <div id="conformation_header">conform your boxoffice account using one of the below methods</div> 
		   <div id="server_side_code_warning" style="display:none;">DUE TO SOME TECHNICAL ERROR THIS PROCCESS WAS NOT SUCCESSFULL TRY AGAIN</div> 
		   <div id="server_side_wrong_code_warning" style="display:none;">CODE IS NOT MATCHING PLEASE TRY AGAIN</div> 
		   <div id="code_warning" style="display:none;">SHORTOUT ALL WARNING ABOUT VERIFICATION CODE BELOW IN RED COLOR</div> 
		   <div id="code_warning1" style="display:none;">PLESEA DON'T SUBMIT BLANK CODE SUBMIT WITH PROPER CODE</div> 
		    <div id="code_warning2" style="display:none;">CODE LENGTH IS GRETER THAN 10 DIGITS, SUBMIT UNDER 10 DIGITS</div>
	     <table>
		   <tbody>
		       ...
		       <tr>
			     ...
			     <td >
				 <span class="email_con"><?php $sql="select email from user_profile_data where uname='$myarr[0]'"; $r=mysqli_query($conn,$sql); $row=mysqli_fetch_assoc($r); echo $row["email"]; ?></span>
				 </td>
				 <td>
				 ...
				 <form accept-charset="UTF-8" action="email_conform_account_done.php" name="email_verfication" id="email_verfication" method="post" onsubmit="return email_con_validation()" novalidate>
				    <input placeholder="Enter the code" type="text" name="email_code" id="e_code" size="25" onkeyup="email_ajax_vali(this.value)"/><br><br>
			   ...
			   <tr>
			    <td ><span class="mobile_con"><?php $sql="select mobile_number from user_profile_data where uname='$myarr[0]'"; $r=mysqli_query($conn,$sql); $row=mysqli_fetch_assoc($r); echo $row["mobile_number"]; ?></span></td>
				...
				<form accept-charset="UTF-8" action="mobile_conform_account_done.php" name="mobile_verfication" id="mobile_verfication" method="post" onsubmit="return mobile_con_validation()" novalidate>
				     <input placeholder="Enter the code" type="text" id="m_code" name="mobile_code" size="25" onkeyup="mobile_ajax_vali(this.value)"/><br><br>
					 <button type="submit" style="color:white; border:solid thin black; border-radius:3px; font-weight:600; background-color:black; padding:4px 4px 0px 4px;">Submit</button>
				 </form>
	                   ...
	                   <a href="profile.php"><button type="buttom" class="later_buttom">Later</button></a>
        </div>
      ...
      <ol class="notication_about_account">
	    <li>account conformation is very important to every boxoffice user</li>
		<li>to access all features of boxoffice you must conform your account</li>
